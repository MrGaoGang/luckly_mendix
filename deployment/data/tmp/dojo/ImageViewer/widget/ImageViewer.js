require({cache:{
'url:ImageViewer/widget/template/ImageViewer.html':"<div data-dojo-attach-point=\"MRGaoImageRoot\">\r\n    <img data-dojo-attach-point=\"MRGaoImage\" src=\"\"></img>\r\n</div>\r\n\r\n"}});
/*global logger*/
/*
    ImageViewer
    ========================
...
define("ImageViewer/widget/ImageViewer", [
    "dojo/_base/declare",
    ...
    return declare(
        ...
        [_WidgetBase, _TemplatedMixin],
        {
            ...
            update: function(obj, callback) {
                ...
                $(this.MRGaoImage).css("width", this.imageWidth);
                $(this.MRGaoImage).css("height", this.imageHeight);
                //获取属性的值
                var attr = this._contextObj.get(this.dataAttr);
              
                if (attr && attr != "") {
                    dojoProp.set(this.MRGaoImage, "src", attr);
                }
...
require(["ImageViewer/widget/ImageViewer"]);
